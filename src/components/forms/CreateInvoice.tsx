        ...
        <Form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>
          <div className="flex flex-col gap-5">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Badge
                variant="secondary"
                className="mt-6 flex h-fit w-full flex-col bg-muted-foreground/25 justify-end gap-1 border-2 border-dashed border-muted-foreground px-5 font-jura font-medium"
              >
